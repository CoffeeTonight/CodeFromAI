...
from scan_inst.connect_endpoints import _explain_hierarchy_miss
...
def test_emit_connect_log_includes_success_endpoint_provenance():
    from scan_inst.connectivity import emit_connect_trace_log
    from scan_inst.hierarchy_log import format_endpoint_provenance_line
    from scan_inst.models import ConnectEndpoint, ConnectResult
