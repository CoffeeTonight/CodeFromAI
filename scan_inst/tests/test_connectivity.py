...
def test_constant_tieoff_masks_do_not_connect_src():
    from scan_inst.connect_scan import _effective_assign_rhs_roots
...
def test_param_pairs_balanced_parens_and_ternary():
    from scan_inst.params import parse_param_pairs, resolve_param_map
...
def test_parse_connect_pairs_json_shapes():
    from scan_inst.connectivity import parse_connect_pairs_json
