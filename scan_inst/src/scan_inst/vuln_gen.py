...
from scan_inst.vuln_plan import VULN_PLAN, VulnCaseSpec
...
def run_vuln_trial(*, seed: Optional[int] = None) -> Tuple[VulnDesign, VulnTrialResult]:
    ...
    with tempfile.TemporaryDirectory(prefix="scan_inst_vuln_") as tmp:
...
def format_vuln_report(
    ...
    *,
    ...
    from scan_inst.vuln_plan import remediation_summary
