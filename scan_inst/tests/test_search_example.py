"""scan-inst --example search JSON generator."""
...
from scan_inst.run_request import loads_json_document
from scan_inst.search_example import SEARCH_EXAMPLE_FILENAME, search_example_text
