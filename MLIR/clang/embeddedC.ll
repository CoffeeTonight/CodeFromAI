; ModuleID = 'embeddedC.c'
source_filename = "embeddedC.c"
target datalayout = "e-m:e-i8:8:32-i16:16:32-i64:64-i128:128-n32:64-S128"
target triple = "aarch64-unknown-linux-gnu"

@.str = private unnamed_addr constant [20 x i8] c"Hello, Embedded C!\0A\00", align 1

; Function Attrs: mustprogress noinline nounwind optnone uwtable
define dso_local void @_Z5setupv() #0 {
  ret void
}
...
define dso_local void @_Z4loopi(i32 noundef %0) #1 {
  ...
  %4 = sext i32 %3 to i64
  store i64 %4, ptr inttoptr (i64 4096 to ptr), align 8
...
3:                                                ; preds = %0, %3
  ...
  call void @_Z4loopi(i32 noundef %4)
...
attributes #1 = { mustprogress noinline optnone uwtable "frame-pointer"="non-leaf" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="generic" "target-features"="+fp-armv8,+neon,+outline-atomics,+v8a,-fmv" }
