...
$(BUILD_DIR)/SFR.elf: $(COMMON) cpu_sfr/phase_c.c campaign.ld | $(BUILD_DIR)
	...
	$(LD) $(LDFLAGS) -o $@ $(BUILD_DIR)/SFR_phase_a.o $(BUILD_DIR)/SFR_phase_b.o $(BUILD_DIR)/SFR_phase_c.o
...
$(BUILD_DIR)/SRAM.elf: $(COMMON) cpu_sram/phase_c.c campaign.ld | $(BUILD_DIR)
	...
	$(LD) $(LDFLAGS) -o $@ $(BUILD_DIR)/SRAM_phase_a.o $(BUILD_DIR)/SRAM_phase_b.o $(BUILD_DIR)/SRAM_phase_c.o
...
$(BUILD_DIR)/UART.elf: $(COMMON) cpu_uart/uart_fw.c campaign.ld | $(BUILD_DIR)
	...
	$(LD) $(LDFLAGS) -o $@ $(BUILD_DIR)/UART_phase_a.o $(BUILD_DIR)/UART_phase_b.o $(BUILD_DIR)/UART_phase_c.o
