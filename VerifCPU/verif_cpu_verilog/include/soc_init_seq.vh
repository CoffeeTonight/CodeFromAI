...
`define SOC_INIT_RUN_STEPS \
  ...
  if (rd !== 32'h00000001) $fatal(1, "[SoC] init read mismatch @0x%08h got=0x%08h expect=0x%08h", 32'h40000000, rd, 32'h00000001); \
  ...
  if (rd !== 32'h000000FF) $fatal(1, "[SoC] init read mismatch @0x%08h got=0x%08h expect=0x%08h", 32'h40000004, rd, 32'h000000FF); \
  ...
  if (rd !== 32'h0000CAFE) $fatal(1, "[SoC] init read mismatch @0x%08h got=0x%08h expect=0x%08h", 32'h40000020, rd, 32'h0000CAFE); \
  ...
  if (rd !== 32'h00000080) $fatal(1, "[SoC] init read mismatch @0x%08h got=0x%08h expect=0x%08h", 32'hC0000000, rd, 32'h00000080); \
  decode_read(32'hC0000010, 3'd4, rd, r, p); \
  if (rd !== 32'hDEADDEAD) $fatal(1, "[SoC] init read mismatch @0x%08h got=0x%08h expect=0x%08h", 32'hC0000010, rd, 32'hDEADDEAD); \
