...
from scan_inst.report import RunReport, default_log_path, emit_run_report, write_run_report_log
...
def test_default_log_path_next_to_output(tmp_path):
    ...
    assert default_log_path(str(fl), str(out)) == tmp_path / "hier.tsv.scan-inst.log"
...
def test_emit_run_report_writes_log(tmp_path):
    ...
    assert "scan-inst report" in content
