"""Scan -y/-v library paths for module stubs (blackbox)."""
...
_MODULE_RE = re.compile(r"^\s*(?:module|interface|program)\s+([A-Za-z_]\w*)", re.MULTILINE)
...
def scan_library_modules(
    ...
    *,
    ...
    """Return stub ModuleRecord entries for modules found in library paths."""
