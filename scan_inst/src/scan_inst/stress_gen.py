...
from scan_inst.run_request import RunConfig, write_run_request
...
def build_stress_run_config(design: StressDesign) -> RunConfig:
    """Full scan-inst run JSON for a generated stress design."""
    import json
...
def run_stress_trial(
    *,
    ...
    with tempfile.TemporaryDirectory(prefix="scan_inst_stress_") as tmp:
        root = Path(tmp)
