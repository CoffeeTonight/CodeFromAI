...
from scan_inst.inst_scan import _MODULE_BLOCK_RE
from scan_inst.models import PortInfo
from scan_inst.params import resolve_param_expr, split_module_header
