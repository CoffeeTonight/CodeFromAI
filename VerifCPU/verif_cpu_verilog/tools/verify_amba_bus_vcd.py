...
def protocol_checks_for_all() -> list[tuple[Callable[[VcdDB], Series], str, PredFn]]:
    return [
        ...
        (lambda d: d.series_top("ahb_rdata"), "AHB-Lite DEADBEEF", lambda s: had_value(s, 0xDEADBEEF)),
        ...
        (lambda d: d.series_top("axil_rdata"), "AXI4-Lite 0x80", lambda s: had_value(s, 0x80)),
        (lambda d: d.series_top("axil_rdata"), "AXI4-Lite DEADDEAD", lambda s: had_value(s, 0xDEADDEAD)),
        ...
        (lambda d: d.series_top("axi4_rdata"), "AXI4 0xA3", lambda s: had_value(s, 0xA3)),
