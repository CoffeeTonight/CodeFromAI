...
from scan_inst.connect_expand import build_expand_meta, expand_check_to_pairs
...
from scan_inst.connect_scan import build_module_connect_index, lookup_edge_prov
from scan_inst.elab import elaborate
from scan_inst.index import DesignIndex
from scan_inst.waypoint_fanout import (
...
def test_waypoint_fanout_trace(tmp_path: Path):
    ...
    expand = build_expand_meta(
        ["top.drv"],
        ["top.u_c"],
        map_spec={"kind": "waypoint-fanout", "path_kind": "comb"},
    )
