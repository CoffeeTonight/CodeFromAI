...
_PREFIX = "[scan-inst verify-timing]"
...
def verification_kind_for_mode(mode: str) -> Optional[str]:
    from scan_inst.run_request import RUN_CONN_CHECK, RUN_CONE_TRACE, RUN_IO_TRACE
...
def verification_step_label(cfg) -> Optional[Tuple[str, str]]:
    ...
    from scan_inst.run_request import RUN_CONN_CHECK, RUN_CONE_TRACE, RUN_IO_TRACE
    from scan_inst.run_request import normalize_run_mode
