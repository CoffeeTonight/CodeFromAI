...
def expand_filelist(
    ...
    *,
    ...
    """
    from scan_inst.hch_compat.filelist_cwd import resolve_index_cwd
    ...
    from scan_inst.hch_compat.platform_paths import (
...
def build_slang_filelist_lines(fl: FilelistResult) -> List[str]:
    ...
    from scan_inst.hch_compat.platform_paths import path_to_slang
...
def write_slang_filelist_cached(
    ...
    *,
    ...
    from scan_inst.hch_compat.filelist_cache import collect_filelist_mtimes
