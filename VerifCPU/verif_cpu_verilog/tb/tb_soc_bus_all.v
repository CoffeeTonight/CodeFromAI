...
module tb_soc_bus_all;
  ...
  verif_apb2_slave_simple #(.BASE(32'h4000_0000)) u_apb2_s (
    .PCLK(clk), .PRESETn(1'b1), .PADDR(u_apb2.PADDR), .PSEL(u_apb2.PSEL),
    .PENABLE(u_apb2.PENABLE), .PWRITE(u_apb2.PWRITE), .PWDATA(u_apb2.PWDATA),
    .PRDATA(apb2_rdata));

  verif_apb_master u_apb3 (
    .PCLK(clk), .PRESETn(1'b1), .PRDATA(apb3_rdata), .PREADY(apb3_ready), .PSLVERR(apb3_slverr),
    .PADDR(), .PSEL(), .PENABLE(), .PWRITE(), .PWDATA(), .PSTRB(),
    .snoop_valid(), .snoop_wr(), .snoop_addr(), .snoop_data());
  verif_apb_slave_simple u_apb3_s (.PCLK(clk), .PRESETn(1'b1),
  ...
  verif_apb4_master u_apb4 (
    .PCLK(clk), .PRESETn(1'b1), .PRDATA(apb4_rdata), .PREADY(apb4_ready), .PSLVERR(apb4_slverr),
    .PADDR(), .PSEL(), .PENABLE(), .PWRITE(), .PWDATA(), .PSTRB(), .PPROT(),
    .snoop_valid(), .snoop_wr(), .snoop_addr(), .snoop_data());
  verif_apb_slave_simple u_apb4_s (.PCLK(clk), .PRESETn(1'b1),
  ...
  verif_apb5_master u_apb5 (
    .PCLK(clk), .PRESETn(1'b1), .PRDATA(apb5_rdata), .PREADY(apb5_ready), .PSLVERR(apb5_slverr),
    .PADDR(), .PSEL(), .PENABLE(), .PWRITE(), .PWDATA(), .PSTRB(), .PPROT(), .PWAKEUP(),
    .snoop_valid(), .snoop_wr(), .snoop_addr(), .snoop_data());
  verif_apb_slave_simple u_apb5_s (.PCLK(clk), .PRESETn(1'b1),
  ...
  verif_axi_full_master #(.AXI_PROT(3)) u_axi3 (
    ...
    .snoop_valid(), .snoop_wr(), .snoop_addr(), .snoop_data());
  verif_axi_full_slave_simple #(.BASE(32'hA000_0000)) u_axi3_s (.ACLK(clk), .ARESETn(1'b1),
  ...
  verif_axi_full_master #(.AXI_PROT(4)) u_axi4 (
    ...
    .WID(), .WDATA(), .WSTRB(), .WLAST(), .WVALID(), .BREADY(),
    .snoop_valid(), .snoop_wr(), .snoop_addr(), .snoop_data());
  verif_axi_full_slave_simple #(.BASE(32'hA100_0000)) u_axi4_s (.ACLK(clk), .ARESETn(1'b1),
  ...
  verif_axi_full_master #(.AXI_PROT(5)) u_axi5 (
    ...
    .WID(), .WDATA(), .WSTRB(), .WLAST(), .WVALID(), .BREADY(),
    .snoop_valid(), .snoop_wr(), .snoop_addr(), .snoop_data());
  verif_axi_full_slave_simple #(.BASE(32'hA200_0000)) u_axi5_s (.ACLK(clk), .ARESETn(1'b1),
