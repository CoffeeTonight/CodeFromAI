...
from scan_inst.search import path_pattern_match, search
from scan_inst.search_spec import execute_search_spec, parse_search_spec_block
...
def test_scan_inst_cli_regex_path_search(tmp_path: Path):
    rtl = tmp_path / "regex_soc.v"
    rtl.write_text(
        """
module top;
