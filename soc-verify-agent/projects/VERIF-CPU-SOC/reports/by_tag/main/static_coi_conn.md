...
- hierwalk OK — 3 validated check(s) matched expected_connected
...
| 파일 | 경로 |
|------|------|
| verdict | `runs/reproduce-main-20260628-064247/verdict_coi_conn.json` |
| log | `runs/reproduce-main-20260628-064247/coi_conn.log` |
| TSV | `runs/reproduce-main-20260628-064247/coi_conn.tsv` |
