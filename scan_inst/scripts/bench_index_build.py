...
from scan_inst.preprocess import clear_include_unit_cache
from scan_inst.generate_fold import _fold_body_cached
...
def _run_once(
    ...
    *,
    ...
    with tempfile.TemporaryDirectory(prefix="scan_inst_bench_") as td:
        root = Path(td)
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Benchmark scan-inst index build")
